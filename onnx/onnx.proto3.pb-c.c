...
{
  assert(message->base.descriptor == &onnx__int_int_list_entry_proto__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  assert(message->base.descriptor == &onnx__node_device_configuration_proto__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  assert(message->base.descriptor == &onnx__sharding_spec_proto__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  assert(message->base.descriptor == &onnx__sharded_dim_proto__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  assert(message->base.descriptor == &onnx__simple_sharded_dim_proto__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  assert(message->base.descriptor == &onnx__device_configuration_proto__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
static const ProtobufCEnumValue onnx__tensor_proto__data_type__enum_values_by_number[24] =
{
...
static const ProtobufCEnumValueIndex onnx__tensor_proto__data_type__enum_values_by_name[24] =
{
  { "BFLOAT16", 16 },
  { "BOOL", 9 },
  { "COMPLEX128", 15 },
...
static const ProtobufCEnumValue onnx__version__enum_values_by_number[12] =
{
  ...
  { "IR_VERSION", "ONNX__VERSION__IR_VERSION", 11 },
};
static const ProtobufCIntRange onnx__version__value_ranges[] = {
{0, 0},{0, 12}
};
static const ProtobufCEnumValueIndex onnx__version__enum_values_by_name[12] =
{
  { "IR_VERSION", 11 },
